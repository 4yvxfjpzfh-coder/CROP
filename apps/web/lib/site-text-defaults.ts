...
export const SITE_TEXT_GROUPS: SiteTextGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "home.how.step1.text", label: "Paso 1 — texto", default: "Recorré en 3D el excedente disponible hoy en la feria: fotos, precios y cantidades reales.", multiline: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "catalogo.selector.subtext", label: "Subtítulo del selector de ferias", default: "Cada feria tiene su propio recorrido en 3D con el excedente disponible ahí.", multiline: true },
      ...
      { key: "catalogo.gallery.instructions", label: "Instrucciones de la galería 3D", default: "Scrolleá para recorrer el excedente · mové el mouse para mirar alrededor · clic en un producto para ver el detalle.", multiline: true },
